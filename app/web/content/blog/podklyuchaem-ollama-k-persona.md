...
- работу **офлайн** и приватность по дизайну: если Persona развёрнута на той же машине, что и Ollama, переписка не покидает ваше железо (в отличие от режима с облачным ключом, где текст запросов уходит выбранному провайдеру);

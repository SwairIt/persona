...
S6: поверх этого — РЕАЛЬНЫЙ семантический граф знаний (узлы-сущности из
...
async def graph_data(
    ...
    # типом "memory" (зарегистрирован в TYPES фронта, поэтому фильтруется/рендерится),
    # а связи — с подписью relation_type (поле rel).
    try:
